...
<main class="container">
    <form id="orderForm">
        ...
        <section>
            ...
            <div class="form-group">
                ...
                <select name="desa" id="desa">
                    ...
                    <option value="Jambudipa">Jambudipak</option>
            ...
            <div class="form-group">
                ...
                <select name="prov" id="prov">
                    ...
                    <option value="Provinsi DI Yogyakarta">Provinsi DI Yogyakarta</option>
        ...
        <section>
            ...
            <div class="form-group">
                <label>Cari Paket Wisata (Search):</label>
        ...
        <section>
            ...
            <div class="form-group">
                <label>Unggah Bukti KTP/ID (File):</label>
...
document.getElementById('orderForm').addEventListener('submit', function(event) {
    ...
    formData.forEach((value, key) => {
        // Jika kuncinya adalah 'addon', kita masukkan array yang sudah diproses di atas
        if (key === 'addon') {
            dataObj[key] = addons;
    ...
    // Data ini akan tetap ada meskipun browser ditutup
    ...
    for (const [key, value] of Object.entries(dataObj)) {
        // Format nama kunci agar lebih enak dibaca (contoh: promo_code menjadi Promo Code)
